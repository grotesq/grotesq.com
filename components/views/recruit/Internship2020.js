      ...
      <div className="gq-section">
        ...
        <div className="container">
          ...
          <Title textAlign="left">
            <h3 className="font-noto">감사 말씀</h3>
          </Title>
          <p>
            저희 예상보다 훨씬 많은 분들이 지원해주셨고, 많은 관심을 받았습니다.
            <br />
            처음 진행하는 인턴십 프로그램이라 실수도 많았지만, 성황리에 채용을
            마쳤습니다.
            <br />
            한 분이라도 더 많은 분들을 채용하고 싶었지만, 그렇지 못해 안타깝고
            죄송스럽습니다.
            <br />
            더 좋은 프로그램으로 준비해 다시 찾아뵙도록 하겠습니다.
            <br />
            <br />
            <br />
            {fold && (
          ...
          {!fold && (
            <>
              ...
              <p>
                ...
                <br />
                기업에서 필요한 인재는 기업에서 육성하도록 노력해야 한다는
                철학을 실천하고자, 인턴십을 진행하게 되었습니다.
              </p>
              <Title textAlign="left">
              ...
              <p>
                ...
                <br />
                종료 후 채용을 목적으로 진행되는 인턴십이기 때문에, 최소 재직
                기간에 대한 계약이 포함됩니다.
                <br />
