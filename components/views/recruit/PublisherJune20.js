...
const metaDescription = '그로테스큐 스튜디오에서 마크업 개발자(퍼블리셔)를 찾습니다.';
...
const ogDescription = '그로테스큐 스튜디오에서 마크업 개발자(퍼블리셔)를 찾습니다.';
        ...
        <div className="container">
          ...
          <>
            ...
            <p>
              ...
              다양한 프로그램으로 진행 (코로나 19로 인해 난항을 겪고 있으나 해결책을 찾는 중...)
              <br />
              <br />
            ...
            <p>
              <strong>
                다음 목록은 필수는 아니지만 한 가지라도 해당사항이 있으시다면
                저희에게 너무 반가운 부분입니다.
              </strong>
              <br />
              <br />
            ...
            <p>
              저희 업무는 90%가 리액트/리액트 네이티브입니다. 그 외에는 Vue.js,
              AngularJS 등입니다.
              <br />
