    ...
    <div class="gq-section">
        <div class="container">
            ...
            <p class="mt-5">
                ...
                윌라 서비스에는 DRM이 적용된 컨텐츠 제공을 위해 Inka Entworks 의 PallyCon 솔루션을 활용하고 있습니다. Pallycon SDK는 네이티브 언어에 대해서만 제공되기 때문에, 네이티브로 만들어진 플레이어가 브릿지를 통해 리액트 네이티브와 연동될 수 있도록 작업되었습니다.
            </p>
        </div>
    </div>
