...
const WorkFlowSection = styled.section`
  background-image: 
    url('/assets/image/main/workflow/background-1.svg'),
    url('/assets/image/main/workflow/background-3.svg'), 
    url('/assets/image/main/workflow/background-2.svg'),
    url('/assets/image/main/workflow/background-6.svg'),
    url('/assets/image/main/workflow/background-5.svg'), 
    url('/assets/image/main/workflow/background-4.svg'), 
  ...
  return (
    <section>
      <div className="text-center w-full pl-7">
        <Image src="/assets/image/main/workflow/mb_side-arrow-1.svg" width="274" height="125" />
      </div>
      <div className="flex items-end -mt-4">
        ...
        <div className="w-1/3">
          ...
          <div className="text-center">
            <Image src="/assets/image/main/workflow/mb_down-arrow-2.svg" width="8" height="42" />
          </div>
          ...
          <div className="text-left ml-auto">
            <Image src="/assets/image/main/workflow/mb_right-arrow-2.svg" width="94" height="94" />
          </div>
        </div>
      </div>
    </section>
